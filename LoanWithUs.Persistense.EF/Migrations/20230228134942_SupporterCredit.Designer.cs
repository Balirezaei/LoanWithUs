...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230228134942_SupporterCredit")]
    partial class SupporterCredit
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 2, 28, 17, 19, 42, 12, DateTimeKind.Local).AddTicks(9223),
                            UserName = "admin"
                        });
                });
