...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230320112204_applicant_supporter")]
    partial class applicant_supporter
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 3, 20, 14, 52, 3, 999, DateTimeKind.Local).AddTicks(2398),
                            UserName = "admin"
                        });
                });
