...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230412142202_ApplicantLoanRequest")]
    partial class ApplicantLoanRequest
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 4, 12, 17, 52, 2, 347, DateTimeKind.Local).AddTicks(725),
                            UserName = "admin"
                        });
                });
