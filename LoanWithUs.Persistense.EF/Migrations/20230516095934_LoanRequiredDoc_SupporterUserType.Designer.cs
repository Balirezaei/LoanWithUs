...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230516095934_LoanRequiredDoc_SupporterUserType")]
    partial class LoanRequiredDoc_SupporterUserType
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 5, 16, 13, 29, 33, 678, DateTimeKind.Local).AddTicks(4464),
                            UserName = "admin"
                        });
                });
