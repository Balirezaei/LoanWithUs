...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230518084838_penaltyAmount_Int")]
    partial class penaltyAmount_Int
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 5, 18, 12, 18, 38, 136, DateTimeKind.Local).AddTicks(3216),
                            UserName = "admin"
                        });
                });
