...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230710064124_addressInformation_province")]
    partial class addressInformation_province
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 7, 10, 10, 11, 23, 901, DateTimeKind.Local).AddTicks(8309),
                            UserName = "admin"
                        });
                });
