...
namespace LoanWithUs.Persistense.EF.Migrations
{
    ...
    [Migration("20230713100445_educationalInfo_educationalSubject_change")]
    partial class educationalInfo_educationalSubject_change
    {
            ...
            modelBuilder.Entity("LoanWithUs.Domain.Administrator", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            RegisterationDate = new DateTime(2023, 7, 13, 13, 34, 45, 126, DateTimeKind.Local).AddTicks(4495),
                            UserName = "admin"
                        });
                });
